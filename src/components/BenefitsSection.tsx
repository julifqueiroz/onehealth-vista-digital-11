...
import { TrendingUp, DollarSign, Shield, Heart, Clock, Users, BarChart3, Award } from 'lucide-react';
const benefits = [{
  id: 1,
...
const BenefitsSection = () => {
  return <section id="benefits" className="py-20 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-bold">O OneHealth® transforma a maneira como sua farmácia de manipulação opera, gerando resultados mensuráveis e impactando diretamente a sua lucratividade e eficiência operacional.</p>
        </motion.div>
        ...
        once: true
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              {["Redução de Desperdícios", "Otimização de Processos", "Aumento de Vendas", "Fidelização de Clientes"].map((item, index) => <motion.div key={index} initial={{
              opacity: 0,
              x: 20
            }} whileInView={{
              opacity: 1,
        ...
        once: true
          ...
          {additionalBenefits.map((benefit, index) => <div key={index} className="text-center group">
