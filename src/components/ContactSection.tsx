              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">(71) 9607-3520</p>
                  </div>
                </div>
...
Salvador BA</p>
            ...
            <div className="mt-auto">
              <div className="bg-gradient-onehealth text-white p-6 rounded-xl">
                ...
                window.open("https://api.whatsapp.com/send?phone=5571960735200&text=Olá! Gostaria de mais informações sobre o OneHealth", "_blank");
